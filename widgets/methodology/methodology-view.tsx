...
export function MethodologyView() {
  ...
  const BLOCKS: Block[] = [
    ...
    {
      id: "land",
      title: { kk: "Топырақ, құрғақшылық және өрт қаупі", ru: "Почва, засуха и пожарная опасность" },
      formula:
        "Нестеров:  G = Σ T·(T − Td)   по дням подряд без осадков ≥ 3 мм\n" +
        "           классы: I <300 · II <1000 · III <4000 · IV <10000 · V ≥10000\n" +
        "Td (Магнус): Td = b·α / (a − α),  α = a·T/(b+T) + ln(RH/100)\n" +
        "Почва:     балл = влажность 0–7 см / 0,30 · 100\n" +
        "Увлажнение: балл = 0,65·(осадки₉₀ / 90 мм) + 0,35·(1 − сушь / 60 дней)",
      body: {
